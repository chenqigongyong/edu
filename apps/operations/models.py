...
class UserLove(models.Model):
    ...
    love_type = models.CharField(choices=((1,'org'),(2,'course'),(3,'teacher')),verbose_name='收藏类别',max_length=10)
...
class UserCourse(models.Model):
    ...
    add_time = models.DateTimeField(auto_now=True, verbose_name='学习时间')
