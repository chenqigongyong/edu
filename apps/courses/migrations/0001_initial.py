    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iamge', models.ImageField(max_length=200, upload_to='course/', verbose_name='课程封面')),
                ...
                ('orginfo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orgs.OrgsInfo', verbose_name='所属机构')),
